...
function TechStack() {
  return (
    <div className="relative mt-10 hidden md:block">
      <div className="absolute right-0 z-40 h-full w-20 bg-white dark:bg-black sm:hidden" style={{ maskImage: "linear-gradient(to left, white, transparent)" }}></div>

      <div className="relative z-20 mb-4 flex flex-wrap items-center justify-center gap-4 overflow-x-auto no-scrollbar">
        {/* Next.js */}
        <div className="flex items-center space-x-1">
          ...
          <span className="text-sm font-semibold text-neutral-500">Next.js</span>
        </div>
        ...
        <div className="flex items-center space-x-1">
          ...
          <span className="text-sm font-semibold text-neutral-500">React</span>
        </div>
        ...
        <div className="flex items-center space-x-1">
          ...
          <span className="text-sm font-semibold text-neutral-500">Tailwind CSS</span>
        </div>
        ...
        <div className="flex items-center space-x-1">
          ...
          <span className="text-sm font-semibold text-neutral-500">Motion</span>
        </div>
      </div>
    </div>
  );
